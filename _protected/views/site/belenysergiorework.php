...
?>
    ...
    <div id="id_inicio" class="seccion animatedParent width_70">
    ...
    <div class="seccion animatedParent">
        ...
        <div class="container countdown slowest animated bounceInDown" style="text-align: center"  id="id_ceremonia">
    ...
    <div class="seccion animatedParent" id="id_fiesta">
    ...
    <div class="seccion animatedParent"  id="id_regalos">
    ...
    <div class="seccion animatedParent" id="id_confirmar" >
    ...
    <!-- CONFIRMAR ASISTENCIA CONFIRMAR ASISTENCIA CONFIRMAR ASISTENCIA CONFIRMAR ASISTENCIA CONFIRMAR ASISTENCIA -->
    <div class="seccion seccion_background_gray animatedParent" >
        ...
        <div class="slowest  animated bounceInDown">
            ...
            <button class="btn btn-como-llegar  modalButton" style="margin-top: 30px;" title="<?= $titulo ?>" value="confirmar" id="id_calendario">
    ...
    <div id="id_calendario" class="seccion seccion_background_gray animatedParent">
        <div class="slowest  animated bounceInDown">
            <div class="titulo_nombres" style="font-size:60px">¡Guarda la fecha en tu calendario!</div>
            <!-- COMO CONFIGURAR EL CALENDARIO COMO CONFIGURAR EL CALENDARIO COMO CONFIGURAR EL CALENDARIO COMO CONFIGURAR EL CALENDARIO
            https://support.google.com/calendar/answer/41207?hl=es -->
            <a target="_blank" href="https://calendar.google.com/event?action=TEMPLATE&amp;tmeid=NGw0ZTZwcnZsczlsb2c2OG1wcDV0bXFsZG8gdjNsaGpjZm5tMWg1dmpjMTU1c2RkZnZsYmtAZw&amp;tmsrc=v3lhjcfnm1h5vjc155sddfvlbk%40group.calendar.google.com">
                <img border="0" src="<?= $carpeta ?>../google_calendar.png" width="120">
            </a>
        </div>
    </div>
