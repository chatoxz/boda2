...
?>
<div class="site-login" style="padding: 40px;">

    <div class="" style="max-width: 350px;margin: auto;background-color: rgba(255, 255, 255, 0.9);padding: 15px;border-radius: 5px;">
